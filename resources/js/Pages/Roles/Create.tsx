...
export default function Create({permissions}:{permissions:{data:{id:number,title:string}}[]}) {
...
const options = permissions.data.map((permission:{id:number,title:string})=>{
    return{ value: permission.id, label: permission.title };
});

console.log(data.selectedPermission);
                                ...
                                <div className="bg-white py-6 px-4 space-y-6 sm:p-6">
                                    ...
                                    <div className="grid grid-cols-6 gap-6">
                                        <div className="col-span-6 sm:col-span-3">
                                            ...
                                            />
                                            {errors.title && <div className='text-red-500'>{errors.name}</div>}
                                        </div>
                                       ...
                                       <div className="col-span-6 sm:col-span-3">
                                        ...
                                        <Select 
                                        onChange={(selectedPermission)=>setData('selectedPermission', selectedPermission)}
                                        value={data.selectedPermission}
                                        options={options} 
                                        isMulti/>
